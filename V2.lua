...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://97164108140541",
...
local v52 = v16.Main:AddToggle("ToggleHakiFortress", {
    Title = "Báº­t Haki MĂ u PhĂ¡o ÄĂ i",
    Description = "",
    Default = false
});
...
local v56 = v16.Main:AddSection("ThĂ´ng Tháº¡o");
local v57 = v16.Main:AddDropdown("DropdownMastery", {
    Title = "CĂ y ThĂ´ng Tháº¡o",
    Description = "",
    Values = {
        "Near Mobs"
    },
    ...
    spawn(function()
        pcall(function()
            while wait() do
                ...
                v485:SetDesc("MĂ y CĂ³: " .. tostring(v768) .. " XÆ°Æ¡ng");
            end
        end);
    end);
...
if Sea3 then
    local v490 = v16.Main:AddSection("TÆ° Lá»‡nh BĂ¡nh");
    local v491 = v16.Main:AddParagraph({
        Title = "Tráº¡ng ThĂ¡i NĂ³ Ra",
        Content = ""
    });
    spawn(function()
        while wait() do
            pcall(function()
                if (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88) then
                    v491:SetDesc("CĂ²n: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 41) .. "");
                elseif (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87) then
                    v491:SetDesc("CĂ²n: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 40) .. "");
                elseif (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86) then
                    v491:SetDesc("CĂ²n: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 39) .. " ");
                else
                    v491:SetDesc("TÆ° Lá»‡nh BĂ¡nh : âœ…ï¸");
                end
            end);
        end
    end);
    local v492 = v16.Main:AddToggle("ToggleCake", {
        Title = "CĂ y TÆ° Lá»‡nh BĂ¡nh",
        Description = "",
        Default = false
    });
    local v493 = true;
    ...
    local v495 = v16.Main:AddToggle("ToggleSpawnCake", {
        Title = "Triá»‡u Há»“i TÆ° Lá»‡nh BĂ¡nh",
        Description = "",
        Default = true
    });
...
local v60 = v16.Main:AddSection("TrĂ¹m");
if Sea1 then
    tableBoss = {
        "The Gorilla King",
        "Bobby",
...
local v63 = v16.Main:AddSection("NguyĂªn Liá»‡u");
if Sea1 then
    MaterialList = {
        "Scrap Metal",
        "Leather",
...
if Sea3 then
    local v498 = v16.Sea:AddSection("Äáº£o CĂ¡o");
    local v499 = v16.Sea:AddParagraph({
        Title = "Tráº¡ng ThĂ¡i Äáº£o CĂ¡o",
        Content = ""
    });
    function UpdateKitsune()
        if game:GetService("Workspace").Map:FindFirstChild("KitsuneIsland") then
            v499:SetDesc("Äáº£o CĂ¡o : âœ…ï¸");
        else
            v499:SetDesc("Äáº£o CĂ¡o : âŒï¸");
        end
    end
    spawn(function()
        pcall(function()
...
if Sea3 then
    local v503 = v16.Sea:AddSection("Biá»ƒn");
    ...
    v505.RenderStepped:Connect(function()
        ...
        if v594 then
            ...
            if not v513 then
                v14:Notify({
                    Title = "TBoy Roblox",
                    Content = "Äáº£o Dung Nham TĂ¬m Tháº¥y",
                    Duration = 10
                });
                v513 = true;
            end
    ...
    v505.RenderStepped:Connect(function()
        ...
        if v605 then
            ...
            if not v513 then
                v14:Notify({
                    Title = "TBoy Roblox",
                    Content = "Äáº£o BĂ­ áº¨n TĂ¬m Tháº¥y",
                    Duration = 10
                });
                v513 = true;
            end
    ...
    local v515 = v16.Sea:AddToggle("AutoFindFrozen", {
        Title = "TĂ¬m Äáº£o Leviathan",
        Description = "Cáº§n 5 NgÆ°á»i KhĂ´ng Idk",
        Default = false
    });
    ...
    v505.RenderStepped:Connect(function()
        ...
        if v616 then
            ...
            if not v513 then
                v14:Notify({
                    Title = "TBoy Roblox",
                    Content = "Äáº£o Leviathan TĂ¬m Tháº¥y",
                    Duration = 10
                });
                v513 = true;
            end
    ...
    local v516 = v16.Sea:AddToggle("AutoComeTiki", {
        Title = "LĂ¡i Thuyá»n Vá» Äáº£o Tiki",
        Description = "",
        Default = false
    });
    ...
    local v517 = v16.Sea:AddToggle("AutoComeHydra", {
        Title = "LĂ¡i Thuyá»n Vá» Äáº£o Hydra",
        Description = "",
        Default = false
    });
    ...
    v16.Sea:AddButton({
        ...
        Description = "Duy Nháº¥t Thuyá»n Báº¡n Mua á» Chá»— Chá»n",
        Callback = function()
            v521();
        end
    });
    local v522 = v16.Sea:AddToggle("ToggleTerrorshark", {
        Title = "Äáº¥m CĂ¡ Máº­p",
        Description = "",
        Default = false
    });
...
if Sea3 then
    local v531 = v16.Sea:AddSection("Äáº£o BĂ­ áº¨n");
    ...
    spawn(function()
        pcall(function()
            while wait() do
                v532:SetDesc("Äáº£o BĂ­ áº¨n: " .. MirageStatus .. " | TrÄƒng TrĂ²n: " .. FullMoonStatus);
            end
        end);
    end);
    v16.Sea:AddButton({
...
local v68 = v16.Sea:AddToggle("Togglelockmoon", {
    Title = "NhĂ¬n TrÄƒng VĂ  DĂ¹ng Tá»™c",
    Description = "",
    Default = false
});
...
local v93 = v16.Setting:AddSection("KÄ© NÄƒng ThĂ´ng Tháº¡o");
...
local v99 = v16.Status:AddParagraph({
    Title = "ThĂ´ng Tin",
    Content = "â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”\n" .. "TĂªn : " .. game.Players.LocalPlayer.DisplayName .. " (@" .. game.Players.LocalPlayer.Name .. ")\n" .. "Cáº¥p : " .. game:GetService("Players").LocalPlayer.Data.Level.Value .. "\n" .. "Tiá»n : " .. game:GetService("Players").LocalPlayer.Data.Beli.Value .. "\n" .. "Äiá»ƒm F : " .. game:GetService("Players").LocalPlayer.Data.Fragments.Value .. "\n" .. "Tiá»n Truy NĂ£ : " .. game:GetService("Players").LocalPlayer.leaderstats["Bounty/Honor"].Value .. "\n" .. "MĂ¡u: " .. game.Players.LocalPlayer.Character.Humanoid.Health .. "/" .. game.Players.LocalPlayer.Character.Humanoid.MaxHealth .. "\n" .. "NÄƒng LÆ°á»£ng : " .. game.Players.LocalPlayer.Character.Energy.Value .. "/" .. game.Players.LocalPlayer.Character.Energy.MaxValue .. "\n" .. "Tá»™c : " .. game:GetService("Players").LocalPlayer.Data.Race.Value .. "\n" .. "TrĂ¡i : " .. game:GetService("Players").LocalPlayer.Data.DevilFruit.Value .. "\n" .. "â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”"
});
...
local function v103()
    ...
    local v300 = v297 % 60 ;
    v102:SetDesc(string.format("%02d Tiáº¿ng-%02d PhĂºt-%02d GiĂ¢y", v298, v299, v300));
end
spawn(function()
    while task.wait() do
        pcall(v103);
...
local v105 = v16.Status:AddInput("Input", {
    Title = "Job ID",
    Default = "",
    Placeholder = "DĂ¡n Job ID VĂ o ÄĂ¢y",
    Numeric = false,
    Finished = false,
...
v16.Status:AddButton({
    Title = "Báº¯t Äáº§u Tham Gia Job ID",
    Description = "",
    Callback = function()
...
v16.Player:AddButton({
    Title = "Táº£i Láº¡i NgÆ°á»i ChÆ¡i",
    Description = "",
    Callback = function()
        table.clear(v112);
...
local v114 = v16.Player:AddToggle("ToggleTeleport", {
    Title = "Bay Äáº¿n NgÆ°á»i ChÆ¡i",
    Description = "",
    Default = false
});
...
local v56 = v16.Player:AddSection("KhĂ¡c");
local v115 = v16.Player:AddToggle("ToggleNoClip", {
    Title = "Äi XuyĂªn TÆ°á»ng",
    Description = "",
    Default = true
});
...
local v56 = v16.Teleport:AddSection("Äáº£o");
if Sea1 then
    IslandList = {
        "WindMill",
        "Marine",
...
local v129 = v16.Fruit:AddToggle("ToggleCollect", {
    Title = "Dá»‹ch Chuyá»ƒn Äáº¿n TrĂ¡i",
    Description = "",
    Default = false
});
...
local v56 = v16.Fruit:AddSection("Äá»‹nh Vá»‹");
...
local v140 = v16.Raid:AddToggle("ToggleNextIsland", {
    Title = "Äáº¥m QuĂ¡i Raid+Bay Äáº¿n Äáº£o",
    Description = "",
    Default = false
});
...
local v142 = v16.Raid:AddToggle("ToggleGetFruit", {
    Title = "Láº¥y TrĂ¡i DÆ°á»›i 1 Triá»‡u",
    Description = "",
    Default = false
});
...
if Sea2 then
    v16.Raid:AddButton({
        Title = "Bay Äáº¿n Chá»— Táº­p KĂ­ch",
        Description = "",
        Callback = function()
            Tween2(CFrame.new(- 6438.73535, 250.645355, - 4501.50684));
        end
...
local v56 = v16.Raid:AddSection("Táº­p KĂ­ch Law");
local v143 = v16.Raid:AddToggle("ToggleLaw", {
    Title = "Mua Chip VĂ  Äáº¥m Law",
    Description = "",
    Default = false
});
...
local v56 = v16.Race:AddSection("Tá»™c");
v16.Race:AddButton({
    Title = "Cá»­a Tá»™c",
    Description = "",
    Callback = function()
...
local v144 = v16.Race:AddToggle("ToggleHumanandghoul", {
    Title = "HoĂ n ThĂ nh áº¢i [Human/Ghoul]",
    Description = "",
    Default = false
});
...
local v146 = v16.Race:AddToggle("ToggleKillTrial", {
    Title = "Äáº¥m NgÆ°á»i ChÆ¡i Trong Trial",
    Description = "",
    Default = false
});
...
local v56 = v16.Race:AddSection("Huáº¥n Luyá»‡n");
local v147 = v16.Race:AddToggle("ToggleFarmRace", {
    Title = "CĂ y Luyá»‡n Tá»™c",
    Description = "",
    Default = false
});
local v148 = false;
...
local v56 = v16.Shop:AddSection("Kháº£ NÄƒng");
v16.Shop:AddButton({
    Title = "Nháº£y",
    Description = "",
    Callback = function()
...
v16.Shop:AddButton({
    Title = "Haki Quan SĂ¡t",
    Description = "",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk", "Buy");
    end
});
local v56 = v16.Shop:AddSection("Kiáº¿m");
v16.Shop:AddButton({
    Title = "Cutlass",
    Description = "",
    Callback = function()
...
local v56 = v16.Shop:AddSection("VĂµ");
v16.Shop:AddButton({
    Title = "Black Leg",
    Description = "",
    Callback = function()
...
local v56 = v16.Shop:AddSection("KhĂ¡c");
v16.Shop:AddButton({
    Title = "Äá»•i Chá»‰ Sá»‘",
    Description = "",
    Callback = function()
...
v16.Shop:AddButton({
    Title = "Äá»•i Tá»™c Draco",
    Description = "Chá»‰ á» Biá»ƒn 3",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(5661.5322265625, 1013.0907592773438, - 334.9649963378906));
...
local v56 = v16.Misc:AddSection("Äá»™i");
v16.Misc:AddButton({
    Title = "Háº£i Táº·c",
    Description = "",
    Callback = function()
...
local v56 = v16.Misc:AddSection("Kinh Nghiá»‡m");
local v150 = {
    "KITT_RESET",
    "Sub2UncleKizaru",
...
local v56 = v16.Misc:AddSection("Danh Hiá»‡u");
v16.Misc:AddButton({
    Title = "Danh Hiá»‡u",
    Description = "",
    Callback = function()
...
local v56 = v16.Misc:AddSection("Thá»©c Tá»‰nh");
v16.Misc:AddButton({
    Title = "Thá»©c Tá»‰nh",
    Description = "",
    Callback = function()
...
local v56 = v16.Misc:AddSection("KhĂ¡c");
...
local v56 = v16.Misc:AddSection("SÆ°Æ¡ng");
local function v152()
...
local v155 = v16.Sea:AddToggle("ToggleTPFrozenDimension", {
    Title = "Bay Äáº¿n Äáº£o Leviathan",
    Description = "",
    Default = false
});
...
if Sea3 then
    local v561 = v16.Sea:AddParagraph({
        Title = "Tráº¡ng ThĂ¡i Chip Leviathan",
        Content = ""
    });
    spawn(function()
        pcall(function()
...
local v158 = v16.Sea:AddToggle("ToggleReceiveQuest", {
    Title = "Nháº­n Nhiá»‡m Vá»¥ Lá»­a Äá»",
    Description = "Báº­t LĂªn 1 Láº§n LĂ  Nháº­n 1 Nháº­n Ná»¯a ThĂ¬ Táº¯t Báº­t Láº¡i",
    Default = false
});
...
local v159 = v16.Sea:AddParagraph({
    Title = "Tráº¡ng ThĂ¡i Nhiá»‡m Vá»¥ Lá»­a Äá»",
    Content = ""
});
spawn(function()
    pcall(function()
...
v156:AddButton({
    Title = "Bay Äáº¿n Khu Vá»±c Dragon Dojo",
    Description = "",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(5661.5322265625, 1013.0907592773438, - 334.9649963378906));
        Tween2(CFrame.new(5814.42724609375, 1208.3267822265625, 884.5785522460938));
...
v156:AddButton({
    Title = "Cháº¿ Táº¡o Volcanic Magnet",
    Description = "",
    Callback = function()
        local v395 = {
            [1] = "CraftItem",
...
local v166 = v16.Sea:AddParagraph({
    Title = "HoĂ n ThĂ nh áº¢i Draco V4 (Sá»›m Ra)",
    Content = ""
});
local v167 = v16.Sea:AddToggle("ToggleTrialTeleport", {
    Title = "Bay Äáº¿n Cá»­a Trial Tá»™c Draco",
    Description = "",
    Default = false
});
...
local v168 = v16.Sea:AddSection("Äáº£o Dung Nham");
local v169 = v16.Sea:AddParagraph({
    Title = "Tráº¡ng ThĂ¡i Äáº£o Dung Nham",
    Content = ""
});
spawn(function()
    pcall(function()
        while wait() do
            if ggame:GetService("Workspace").Map:FindFirstChild("PrehistoricIsland") then
                v169:SetDesc("Äáº£o Dung Nham: âœ…ï¸");
            else
                v169:SetDesc("Äáº£o Dung Nham: âŒï¸");
            end
        end
    end);
end);
local v170 = v16.Sea:AddToggle("ToggleTPVolcano", {
    Title = "Bay Äáº¿n Äáº£o Dung Nham",
    Description = "",
    Default = false
});
